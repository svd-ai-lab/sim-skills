...
| Bug | Root Cause | Fix |
|-----|-----------|-----|
| ANSA hangs on launch | `ANSA_SRV=ansa_srv.localdomain` unresolvable + ansa64.bat path quoting | Direct exe call + `ANSA_SRV=localhost` |
...
# SSQ patch applied (shared_v25.0.0 replaced)
