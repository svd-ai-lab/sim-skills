<!-- source: https://dyna.docs.pyansys.com/version/stable/getting-started/installation.html -->
...
[pip](https://pip.pypa.io/en/stable/installation/) with this command:
...
with the [PyAnsys Developer’s Guide](https://dev.docs.pyansys.com/index.html).
...
architecture from the [Releases Page](https://github.com/ansys/pydyna/releases).
