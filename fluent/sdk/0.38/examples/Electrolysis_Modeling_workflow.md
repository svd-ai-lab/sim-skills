...
![Mesh](https://fluent.docs.pyansys.com/version/stable/_images/Electrolysis_Modeling_1.png)
...
```
Download Jupyter notebook: Electrolysis_Modeling_workflow.ipynb
Download Python source code: Electrolysis_Modeling_workflow.py
Download zipped: Electrolysis_Modeling_workflow.zip
```
