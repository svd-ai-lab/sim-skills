...
![Problem Schematic](https://fluent.docs.pyansys.com/version/stable/_images/ablation-problem-schematic.png)
...
![residual](https://fluent.docs.pyansys.com/version/stable/_images/ablation-residual.png)

Scaled residual plot

![Drag force in x direction](https://fluent.docs.pyansys.com/version/stable/_images/ablation-drag_force_x.png)

History of the drag force on the ablation wall

![Average pressure on the ablation wall](https://fluent.docs.pyansys.com/version/stable/_images/ablation-avg_pressure.png)

History of the averaged pressure on the ablation wall

![Recede point (albation)](https://fluent.docs.pyansys.com/version/stable/_images/ablation-recede_point.png)
...
![Static Pressure Contour](https://fluent.docs.pyansys.com/version/stable/_images/ablation-pressure.png)
...
![Mach Number Contour](https://fluent.docs.pyansys.com/version/stable/_images/ablation-mach-number.png)
...
```
Download Jupyter notebook: modeling_ablation.ipynb
Download Python source code: modeling_ablation.py
Download zipped: modeling_ablation.zip
```
