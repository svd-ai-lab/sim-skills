...
![../../_images/lunar_lander_thermal_setup.png](https://fluent.docs.pyansys.com/version/stable/_images/lunar_lander_thermal_setup.png)
...
Define the function that converts the Sun’s altitude and azimuth, as calculated by `calc_sun_vecs_for_moon` , into a beam direction in Cartesian coordinates that can be used in Fluent. The coordinate system used is:
...
```
autosave = solver_session.settings.file.auto_save
...
![../../_images/lunar_lander_regolith_temps.png](https://fluent.docs.pyansys.com/version/stable/_images/lunar_lander_regolith_temps.png)

The expected plot for the spacecraft’s minimum, mean, and maximum temperatures (Figure 2) is as follows.

![../../_images/lunar_lander_sc_temps.png](https://fluent.docs.pyansys.com/version/stable/_images/lunar_lander_sc_temps.png)
