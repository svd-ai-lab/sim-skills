...
![One-Way Fluid-Structure Interaction Model](https://fluent.docs.pyansys.com/version/stable/_images/fsi_1way_1.png)
...
![Velocity Contour](https://fluent.docs.pyansys.com/version/stable/_images/fsi_1way_2.png)

# Structural model and material setup #

To analyze the deformation of a steel probe under fluid flow, Linear Elasticity Structural model is chosen
...
configure Fluent to define the steel probe’s support and movement using structural boundary conditions
...
Fluent uses gauge pressure for fluid-structure interaction force calculations. By setting `include_pop_in_fsi_force` to `True` , Fluent uses absolute pressure.
...
![Structural Displacement Contour](https://fluent.docs.pyansys.com/version/stable/_images/fsi_1way_3.png)
...
[1] Modeling One-Way Fluid-Structure Interaction (FSI) Within Fluent, Ansys Fluent documentation.
