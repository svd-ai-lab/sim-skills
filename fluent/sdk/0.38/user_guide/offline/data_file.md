...
The `DataFile` class allows you to access solution data without a live Fluent session. You command `DataFile` objects to read your Fluent data files before you access the data through the `DataFile` methods.
