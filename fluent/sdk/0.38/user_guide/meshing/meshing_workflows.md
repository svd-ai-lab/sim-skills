...
You can use PyFluent to access the classic meshing workflows which align with the journal syntax.

## Watertight geometry meshing workflow #

Use the Watertight Geometry workflow for watertight CAD geometries that require little cleanup. This is useful for clean geometries that have already been prepped in another software, such as Ansys SpaceClaim. The following example shows you how to use the Watertight Geometry workflow.
