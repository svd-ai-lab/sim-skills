...
A cylindrical combustor burning methane ( $C{H}_{4}$ ) in air is studied using the eddy-dissipation model in PyFluent.
...
![../../_images/setup.png](https://fluent.docs.pyansys.com/version/stable/_images/setup.png)

Combustion of Methane Gas in a Turbulent Diffusion Flame Furnace#

## Background #

In this tutorial, we will use the generalized eddy-dissipation model to analyze the methane-air combustion system. The combustion will be modeled using a global one-step reaction mechanism, assuming complete conversion of the fuel to $C{O}_{2}$ and ${H}_{2}O$ . The reaction equation is

$$
C{H}_{4}+2{H}_{2}O\to C{O}_{2}+4{H}_{2}
$$
...
![../../_images/mesh.png](https://fluent.docs.pyansys.com/version/stable/_images/mesh.png)
...
![../../_images/contour-temp.png](https://fluent.docs.pyansys.com/version/stable/_images/contour-temp.png)
...
![../../_images/vector-vel.png](https://fluent.docs.pyansys.com/version/stable/_images/vector-vel.png)

Velocity Vectors#

The entrainment of air into the high-velocity methane jet is clearly visible.

Display filled contours of mass fraction of $C{H}_{4}$ and save the image to a file.
...
![../../_images/contour-ch4-mass-fraction.png](https://fluent.docs.pyansys.com/version/stable/_images/contour-ch4-mass-fraction.png)

Contours of C{H}_{4} Mass Fraction#

Display filled contours of mass fraction of ${O}_{2}$ and save the image to a file.
...
![../../_images/contour-o2-mass-fraction.png](https://fluent.docs.pyansys.com/version/stable/_images/contour-o2-mass-fraction.png)

Contours of {O}_{2} Mass Fraction#

Display filled contours of mass fraction of $C{O}_{2}$ and save the image to a file.
...
![../../_images/contour-co2-mass-fraction.png](https://fluent.docs.pyansys.com/version/stable/_images/contour-co2-mass-fraction.png)

Contours of C{O}_{2} Mass Fraction#

Display filled contours of mass fraction of ${H}_{2}O$ and save the image to a file.
...
![../../_images/contour-h2o-mass-fraction.png](https://fluent.docs.pyansys.com/version/stable/_images/contour-h2o-mass-fraction.png)

Contours of {H}_{2}O Mass Fraction#
...
$$
\overline{T}=\frac{\int T\rho \stackrel{\to }{v}\cdot d\stackrel{\to }{A}}{\int \rho \stackrel{\to }{v}\cdot d\stackrel{\to }{A}}
$$
