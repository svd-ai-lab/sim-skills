...
![Pump Volute Mesh](https://fluent.docs.pyansys.com/version/stable/_images/pump-volute-mesh.png)
...
![Static Pressure Contour](https://fluent.docs.pyansys.com/version/stable/_images/static-pressure-contour.png)
...
```
Download Jupyter notebook: frozen_rotor_workflow.ipynb
Download Python source code: frozen_rotor_workflow.py
Download zipped: frozen_rotor_workflow.zip
```
