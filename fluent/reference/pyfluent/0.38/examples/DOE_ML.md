...
Water enters a Mixing Elbow from two Inlets; Hot (313 K) and Cold (293 K) and exits from Outlet. Using PyFluent in the background, this example runs Design of Experiments (DOE) with Cold Inlet Velocity and Hot Inlet Velocity as Input Parameters and Outlet Temperature as an Output Parameter.

Results can be visualized using a Response Surface. Finally, Supervised Machine Learning Regression Task is performed to build the ML Model.
...
![Regression Model Predictions](https://fluent.docs.pyansys.com/version/stable/_images/doe_ml_predictions_regression.png)
...
![Neural Network Validation Loss](https://fluent.docs.pyansys.com/version/stable/_images/doe_ml_validation_loss.png)

Neural Network Validation Loss

![Neural Network Predictions](https://fluent.docs.pyansys.com/version/stable/_images/doe_ml_predictions_neural_network.png)
