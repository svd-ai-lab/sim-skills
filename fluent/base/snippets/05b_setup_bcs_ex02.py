# Step 5b: Set boundary conditions for EX-02.
# cold-inlet: 0.6 m/s / 20°C (293.15 K), hydraulic diameter 4 in, intensity 5%
...
cold_inlet.momentum.velocity_magnitude.value = 0.6
