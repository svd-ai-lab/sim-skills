"""Step 1: Classic textbook LP (verified E2E).
...
Optimum: (x, y) = (2, 6), obj = 36.
Observed via HiGHS: matches to machine precision.

Run: sim run 01_lp_classic.py --solver pyomo
"""
import json
...
def main():
    ...
    for name in ('appsi_highs', 'glpk', 'cbc'):
        ...
        print(json.dumps({"ok": False, "error": "no LP solver"})); return
